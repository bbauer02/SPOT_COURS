...
ifeval::[{_show_changelog} == 1]
*Notes de version*

[.changelog]
====
* [.adpm-version-number]#1.0.1# du [.adpm-version-date]#14/04/2025 à 14:04#
** Correction d'une erreur de saisie dans les adresses IP attribuées au service Marketing : `192.168.100.20` -> `192.168.200.20`
====
//end _show_changelog
endif::[]
== Préambule
...
|*Adresses attribuées*
|192.168.200.15 à 192.168.200.20
