...
//
//chemin relatif vers les images_docker de l'exercice (pour les images_docker, asciidoc utilise comme point de départ le fichier depuis lequel est appelée la génération)
