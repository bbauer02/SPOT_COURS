...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// nombre de répertoire à remonter depuis un livre ou un chapitre pour arriver à la racine du projet. Comme les livres et les dossiers sont à une profondeur de 3, il faut remonter trois dossiers. C'est utile pour trouver le dossier des images_docker et le dossier des templates de thème car pour ces éléments, il faut utiliser un chemin qui part du fichier depuis lequel est généré le pdf
:_depth_default: ../../../
...
:_system_start:
//
// chemin à remonter depuis un fichier situé dans src ou dans config pour arriver à la racine du projet. (attention, ce chemin relatif n'est pas applicable pour les chemins d'images_docker et de thèmes, ces derniers étant relatifs au fichier qui fait l'objet d'une génération pdf)
...
//
// nom des dossiers contenant des images_docker
:_foldername_container_images: images
//
// nom des dossiers contenant des inclusions
:_foldername_container_includes: includes
//
// nom du dossier qui doit contenir les images_docker des diagrammes asciidoc-diagram
...
//
// chemin absolu vers le répertoire local des images_docker d'un livre (c'est-à-dire par rapport au livre courant)
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
//chemin du dossier de thèmes de l'utilisateur
:_folder_path_themes_user: {_foldername_container_config_user}/{_foldername_container_themes}/
//
//chemin du fichier de thème pdf par défaut par rapport à la racine du projet
:_file_path_themes_default: {_foldername_container_src}/{_foldername_container_themes}/default-theme.yml
//
//chemin du dossier de thèmes par défaut prévoyant une image en couverture par rapport à la racine du projet
:_file_path_themes_default_with_cover_image: {_foldername_container_src}/{_foldername_container_themes}/default-with-cover-image-theme.yml
//
//
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
