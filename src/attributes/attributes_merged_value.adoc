...
//
// ----------------------------------------------------------------------------
// Import des valeurs globales d'attribut d'application définies par l'utilisateur
// ----------------------------------------------------------------------------
...
//
//
//s'il n'est pas défini d'image de couverture au niveau global et qu'une image est définie au niveau local, alors il faut utiliser le répertoire des images_docker d'un livre.
...
//Si l'image est définie au niveau global et que le nom de l'image n'est pas le même après inclusion de la valeur définie localement, alors, c'est qu'il faut utiliser l'image locale (définie au niveau d'un livre)
...
//
//
//s'il n'est pas défini d'image de fond pour toutes les pages au niveau global et qu'une image est définie au niveau local, alors il faut utiliser le répertoire des images_docker d'un livre.
...
//Si l'image est définie au niveau global et que le nom de l'image n'est pas le même après inclusion de la valeur définie localement, alors, c'est qu'il faut utiliser l'image de fond locale (définie au niveau d'un livre)
ifdef::_global_page_image[]
ifeval::["{_global_page_image}" != "{_user_background_image_for_all_pages}"]
:_local_page_image:
//end eval
endif::[]
endif::_global_page_image[]
